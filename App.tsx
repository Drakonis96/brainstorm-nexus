  ...
  return (
    <Layout backgroundImage={backgroundImage} title={appTitle}>
      <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto mt-10 items-stretch">
        {/* TEACHER CARD */}
        <Card className="h-full min-h-[400px] hover:shadow-md transition-shadow border-l-4 border-l-blue-500 flex flex-col justify-between bg-white/95 backdrop-blur">
          {!showAdminPanel ? (
            <>
              <div>
        ...
        {/* STUDENT CARD */}
        <Card className="h-full min-h-[400px] hover:shadow-md transition-shadow border-l-4 border-l-emerald-500 flex flex-col justify-between bg-white/95 backdrop-blur">
           <div>
